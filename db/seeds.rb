...
org4 = Organization.create(name: "Clean up These Streets", city: "NYC", description: "Making these streets clean one way or another", non_profit: true)
org5 = Organization.create(name: "Small Keys", city: "NYC", description: "We make sure there are no small keys anywhere", non_profit: true)
...
mad = User.create(username: "MDulch", age: 25, password: "mad123", bio: "I'm an NYC native, and I care about keeping my city beautiful", organization_id: org6.id, address: "11 Broadway", city: "New York City", state: "NY", zip: 10004, lat: 40.70537509685621, lng: -74.01399268446856, avatar: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRa5yutxtcuCiL6R3u3zh6gLQyR3Zz8RY4bLg&usqp=CAU")
...
job2 = Job.create(location_id: bull.id, description: "Someone spray-painted the Bull's balls, and we gotta fix it", job_name: "Fix the Bull", image: "https://i.insider.com/5dc565643afd3741cd61df62?width=700")
...
job7 = Job.create(location_id: statue.id, description: "A famous status in Central Park was vandalized! Let's scrub it off", job_name: "Status Renovation", image: "https://nypost.com/wp-content/uploads/sites/2/2021/04/columbus-circle-statue-graffiti-1.jpg?quality=90&strip=all&w=1024")
